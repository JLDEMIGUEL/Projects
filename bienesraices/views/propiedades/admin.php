            ...
            <?php foreach ($propiedades as $propiedad) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a class="boton-amarillo" href="/propiedades/actualizar?id=<?php echo $propiedad->id; ?>">Actualizar</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
            ...
            <?php foreach ($vendedores as $vendedor) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a class="boton-amarillo" href="/vendedores/actualizar?id=<?php echo $vendedor->id; ?>">Actualizar</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
